...
<body>
            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <ul class="breadcrumb">
                     ...
                     <li>  »  <li>
                     <li><a href="info_grammateias.php<?php echo $for_login; ?>">Πληροφορίες Γραμματείας</a></li>
                   </ul>
                </div>
            </div>
        </div>
    ...
    <div class="games-area section-padding-100-0">
      ...
      <div id="myId">
        <button class="accordion">Ποιές είναι οι αρμοδιότητές μου;</button>
  			<div class="panel">
          <p style="color:black;"> Οι λειτουργίες της Γραμματείας είναι να διαχειριζεται τα υπάρχουσα βιβλία για κάθε μάθημα καθώς και να εισάγει νέα.<br> Για οποιαδήποτε περαιτέρο πληροφορεία παρακαλώ επικοινωνήστε.</p>
      </div>

  			<button class="accordion" > Πως να διαχειριστώ συγγράμματα; </button>
  			<div class="panel"  id="C2">
          <p style="color:black;"> Στο menu πλοήγησης στην κατηγορία Γραμματεία υπάρχει επιλογή "Διαχείριση Συγγραμμάτων."<br> (Συντομία: Αρχική Σελίδα δεύτερο εικονίδιο).<br> Έπειτα επιλέγεις μια λειτουργία κάποια συγγράμματα και πατάς Υποβολή.<br> Επιβεβαιώνεις την επιλογή σου και τελείωσες!! </p>
  			</div>

  			<button class="accordion"> Πως να διαχειριστώ μαθήματα; </button>
  			<div class="panel">
          <p style="color:black;"> Αντίστοιχα με την Διαχείριση Συγγραμμάτων. </p>
